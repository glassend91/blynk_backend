...
router.post(
    ...
    requireAdmin,
    [
        body('amount').isFloat({ min: 0.1 }).withMessage('Amount must be at least 0.10'),
        body('description').notEmpty().withMessage('Description is required')
    ],
    validateRequest,
    BillingController.processAdminManualCharge
);
